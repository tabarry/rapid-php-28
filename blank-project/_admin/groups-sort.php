                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <!-- TABLE -->
                                <div class="container"><a href="<?php echo ADMIN_URL; ?>groups<?php echo PHP_EXTENSION; ?>/?overlay=<?php echo $_GET['overlay']; ?>" class="btn btn-black pull-right"><i class="fa fa-table"></i></a></div>
                                <div class="clearfix"></div>

                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>groups-remote<?php echo PHP_EXTENSION; ?>/sort/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >
                                    <ul id="sortable">
